...
import { ArrowLeft, Send, MessageCircle, Search, User, Circle, ChevronLeft } from "lucide-react";
...
export default function StudentChat() {
    ...
    return (
        <div className="h-screen bg-[#f1f3f6] font-sans flex flex-col overflow-hidden">
            {/* Top Bar */}
            <div className="bg-white border-b border-slate-100 px-6 py-4 flex items-center gap-4 shrink-0 shadow-sm z-20">
                <button onClick={() => router.push('/dashboard/student')} className="p-2 hover:bg-slate-100 rounded-xl transition-all">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Chat with your Teachers</p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="flex-1 overflow-y-auto">
                        {loading ? (
                            ...
                            filteredContacts.map(contact => (
                                ...
                                >
                                    <div className="relative">
                                        <div className="w-12 h-12 bg-gradient-to-br from-indigo-400 to-purple-500 rounded-2xl flex items-center justify-center text-white font-black text-sm shadow-lg shadow-indigo-500/20">
                    ...
                    {selectedContact ? (
                        <>
                            ...
                            <div className="bg-white px-6 py-4 border-b border-slate-100 flex items-center gap-4 shrink-0">
                                ...
                                <div className="w-10 h-10 bg-gradient-to-br from-indigo-400 to-purple-500 rounded-2xl flex items-center justify-center text-white font-black text-xs shadow-md shadow-indigo-500/20">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-1.5">
                                        ...
                                        <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{selectedContact.role}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex-1 overflow-y-auto px-6 py-6 space-y-1">
                                {groupedMessages.length > 0 ? (
                                    ...
                                    <div className="h-full flex flex-col items-center justify-center text-center">
                                        ...
                                        <p className="text-xs text-slate-400 font-medium">Say hello to {selectedContact.firstName}!</p>
                                    </div>
                                )}
                        ...
                        <div className="flex-1 flex flex-col items-center justify-center text-center px-8">
                            ...
                            <h2 className="text-2xl font-black text-slate-800 mb-2">Welcome to Messages</h2>
                            <p className="text-sm text-slate-400 font-medium max-w-sm">Select a teacher from the contacts panel to start a conversation.</p>
                        </div>
                    )}
                </div>
            </div>
